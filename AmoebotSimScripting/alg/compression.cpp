...
/*
  ...
  */
//  int newRound = 0;
//  if (system.activatedParticles.size() == system.particles.size()) {
//    newRound = 12345;
//    system.activatedParticles.clear();
//  }
